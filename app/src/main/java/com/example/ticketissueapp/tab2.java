...
public class tab2 extends Fragment {
    ...
    private FirestoreRecyclerAdapter<ticket, tab2.DataViewHolder> adapter;
    private Query query;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final CollectionReference datasRef = mDatabase.collection("tickets_pending");
        query = datasRef;
    ...
    public void onStart(){
        ...
        FirestoreRecyclerOptions<ticket> options = new FirestoreRecyclerOptions.Builder<ticket>()
                ...
                .build();
        adapter = new FirestoreRecyclerAdapter<ticket, tab2.DataViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull tab2.DataViewHolder dataViewHolder, int i, @NonNull ticket data) {
            ...
            @NonNull
            @Override
            public tab2.DataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ticket_item, parent, false);

                return new tab2.DataViewHolder(view);
            }
        };
